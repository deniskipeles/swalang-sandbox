...
import { startContributionChat } from '../services/geminiService';
...
const ContributionChatbot: React.FC = () => {
  ...
  useEffect(() => {
    try {
      chatRef.current = startContributionChat();
    } catch (error) {
      console.error("Failed to initialize contribution chat:", error);
